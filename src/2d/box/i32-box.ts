...
export class I32Box implements IntegralBox<I32> {
  ...
  static clamp(x: number, y: number, w: number, h: number): I32Box
  static clamp(xy: Readonly<XY<number>>, wh: Readonly<XY<number>>): I32Box
  static clamp(box: Readonly<Box<number>>): I32Box
  static clamp(
    xXYBox: number | Readonly<XY<number>> | Readonly<Box<number>>,
    yWH?: number | Readonly<XY<number>>,
    w?: number,
    ...
    const box = argsToBox(xXYBox, yWH, w, h)
    return new this(I32XY.clamp(box.x, box.y), I32XY.clamp(box.w, box.h))
  }
  ...
  get centerClamp(): I32XY {
    return I32XY.clamp(this.centerNum)
  }
  ...
  copy(): this {
    return new I32Box(this.x, this.y, this.w, this.h) as this
  }
  ...
  get endClamp(): I32XY {
    return I32XY.clamp(this.endNum)
  }
  ...
  get maxClamp(): I32XY {
    return I32XY.clamp(this.maxNum)
  }
  ...
  get minClamp(): I32XY {
    return I32XY.clamp(this.minNum)
  }
