...
export class U4Box implements IntegralBox<U4> {
  ...
  static ceil(xy: Readonly<XY<number>>, wh: Readonly<XY<number>>): U4Box
  static ceil(box: Readonly<Box<number>>): U4Box
  static ceil(
    ...
    return new this(U4XY.ceil(box.x, box.y), U4XY.ceil(box.w, box.h))
  }

  static clamp(x: number, y: number, w: number, h: number): U4Box
  static clamp(xy: Readonly<XY<number>>, wh: Readonly<XY<number>>): U4Box
  static clamp(box: Readonly<Box<number>>): U4Box
  static clamp(
    xXYBox: number | Readonly<XY<number>> | Readonly<Box<number>>,
    yWH?: number | Readonly<XY<number>>,
    w?: number,
    ...
    const box = argsToBox(xXYBox, yWH, w, h)
    return new this(U4XY.clamp(box.x, box.y), U4XY.clamp(box.w, box.h))
  }

  static floor(x: number, y: number, w: number, h: number): U4Box
  static floor(xy: Readonly<XY<number>>, wh: Readonly<XY<number>>): U4Box
  static floor(box: Readonly<Box<number>>): U4Box
  static floor(
    xXYBox: number | Readonly<XY<number>> | Readonly<Box<number>>,
    yWH?: number | Readonly<XY<number>>,
    w?: number,
    ...
    const box = argsToBox(xXYBox, yWH, w, h)
    return new this(U4XY.floor(box.x, box.y), U4XY.floor(box.w, box.h))
  }

  static round(x: number, y: number, w: number, h: number): U4Box
  static round(xy: Readonly<XY<number>>, wh: Readonly<XY<number>>): U4Box
  static round(box: Readonly<Box<number>>): U4Box
  static round(
    xXYBox: number | Readonly<XY<number>> | Readonly<Box<number>>,
    yWH?: number | Readonly<XY<number>>,
    w?: number,
    ...
    const box = argsToBox(xXYBox, yWH, w, h)
    return new this(U4XY.round(box.x, box.y), U4XY.round(box.w, box.h))
  }

  static fromJSON(json: Readonly<BoxJSON>): U4Box {
    return new this(
      json.xy?.x ?? json.x ?? 0,
      json.xy?.y ?? json.y ?? 0,
      json.wh?.x ?? json.w ?? 0,
  ...
  constructor(
    ...
    const box = argsToBox(xXYBox, yWH, w, h)
    this.#xy = new U4XY(box.x, box.y)
    this.#wh = new U4XY(box.w, box.h)
  }
  ...
  get center(): U4XY {
    return new U4XY(this.centerNum)
  }

  get centerCeil(): U4XY {
    return U4XY.ceil(this.centerNum)
  }

  get centerClamp(): U4XY {
    return U4XY.clamp(this.centerNum)
  }

  get centerFloor(): U4XY {
    return U4XY.floor(this.centerNum)
  }

  get centerRound(): U4XY {
    return U4XY.round(this.centerNum)
  }
  ...
  copy(): this {
    return new U4Box(this.x, this.y, this.w, this.h) as this
  }
  ...
  get end(): U4XY {
    return new U4XY(this.endNum)
  }

  get endClamp(): U4XY {
    return U4XY.clamp(this.endNum)
  }
  ...
  get max(): U4XY {
    return new U4XY(this.maxNum)
  }

  get maxClamp(): U4XY {
    return U4XY.clamp(this.maxNum)
  }
  ...
  get min(): U4XY {
    return new U4XY(this.minNum)
  }

  get minClamp(): U4XY {
    return U4XY.clamp(this.minNum)
  }
