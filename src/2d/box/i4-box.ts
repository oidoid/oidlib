import { Box, I4, I4XY, IntegralBox, NumBox, NumXY, XY } from '@/oidlib';
...
export class I4Box implements IntegralBox<I4> {
  ...
  static trunc(x: number, y: number, w: number, h: number): I4Box;
  static trunc(xy: Readonly<XY<number>>, wh: Readonly<XY<number>>): I4Box;
  static trunc(box: Readonly<Box<number>>): I4Box;
  static trunc(
    xXYBox: number | Readonly<XY<number>> | Readonly<Box<number>>,
    yWH?: number | Readonly<XY<number>>,
    w?: number,
  ...
  get centerTrunc(): I4XY {
    return I4XY.trunc(this.centerNum);
  }
