...
export class I4Box implements IntegralBox<I4> {
  static ceil(x: number, y: number, w: number, h: number): I4Box
  static ceil(xy: Readonly<XY<number>>, wh: Readonly<XY<number>>): I4Box
  static ceil(box: Readonly<Box<number>>): I4Box
  static ceil(
    ...
    return new this(I4XY.ceil(box.x, box.y), I4XY.ceil(box.w, box.h))
  }

  static clamp(x: number, y: number, w: number, h: number): I4Box
  static clamp(xy: Readonly<XY<number>>, wh: Readonly<XY<number>>): I4Box
  static clamp(box: Readonly<Box<number>>): I4Box
  static clamp(
    xXYBox: number | Readonly<XY<number>> | Readonly<Box<number>>,
    yWH?: number | Readonly<XY<number>>,
    w?: number,
    ...
    const box = argsToBox(xXYBox, yWH, w, h)
    return new this(I4XY.clamp(box.x, box.y), I4XY.clamp(box.w, box.h))
  }

  static floor(x: number, y: number, w: number, h: number): I4Box
  static floor(xy: Readonly<XY<number>>, wh: Readonly<XY<number>>): I4Box
  static floor(box: Readonly<Box<number>>): I4Box
  static floor(
    xXYBox: number | Readonly<XY<number>> | Readonly<Box<number>>,
    yWH?: number | Readonly<XY<number>>,
    w?: number,
    ...
    const box = argsToBox(xXYBox, yWH, w, h)
    return new this(I4XY.floor(box.x, box.y), I4XY.floor(box.w, box.h))
  }

  static round(x: number, y: number, w: number, h: number): I4Box
  static round(xy: Readonly<XY<number>>, wh: Readonly<XY<number>>): I4Box
  static round(box: Readonly<Box<number>>): I4Box
  static round(
    xXYBox: number | Readonly<XY<number>> | Readonly<Box<number>>,
    yWH?: number | Readonly<XY<number>>,
    w?: number,
    ...
    const box = argsToBox(xXYBox, yWH, w, h)
    return new this(I4XY.round(box.x, box.y), I4XY.round(box.w, box.h))
  }
  ...
  constructor(
    ...
    const box = argsToBox(xXYBox, yWH, w, h)
    this.#xy = new I4XY(box.x, box.y)
    this.#wh = new I4XY(box.w, box.h)
  }
  ...
  get center(): I4XY {
    return new I4XY(this.centerNum)
  }

  get centerCeil(): I4XY {
    return I4XY.ceil(this.centerNum)
  }

  get centerClamp(): I4XY {
    return I4XY.clamp(this.centerNum)
  }

  get centerFloor(): I4XY {
    return I4XY.floor(this.centerNum)
  }

  get centerRound(): I4XY {
    return I4XY.round(this.centerNum)
  }
  ...
  copy(): this {
    return new I4Box(this.x, this.y, this.w, this.h) as this
  }
  ...
  get end(): I4XY {
    return new I4XY(this.endNum)
  }

  get endClamp(): I4XY {
    return I4XY.clamp(this.endNum)
  }
  ...
  get max(): I4XY {
    return new I4XY(this.maxNum)
  }

  get maxClamp(): I4XY {
    return I4XY.clamp(this.maxNum)
  }
  ...
  get min(): I4XY {
    return new I4XY(this.minNum)
  }

  get minClamp(): I4XY {
    return I4XY.clamp(this.minNum)
  }
