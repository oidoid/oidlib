...
export class I8Box implements IntegralBox<I8> {
  static ceil(x: number, y: number, w: number, h: number): I8Box
  static ceil(xy: Readonly<XY<number>>, wh: Readonly<XY<number>>): I8Box
  static ceil(box: Readonly<Box<number>>): I8Box
  static ceil(
    ...
    return new this(I8XY.ceil(box.x, box.y), I8XY.ceil(box.w, box.h))
  }

  static clamp(x: number, y: number, w: number, h: number): I8Box
  static clamp(xy: Readonly<XY<number>>, wh: Readonly<XY<number>>): I8Box
  static clamp(box: Readonly<Box<number>>): I8Box
  static clamp(
    xXYBox: number | Readonly<XY<number>> | Readonly<Box<number>>,
    yWH?: number | Readonly<XY<number>>,
    w?: number,
    ...
    const box = argsToBox(xXYBox, yWH, w, h)
    return new this(I8XY.clamp(box.x, box.y), I8XY.clamp(box.w, box.h))
  }

  static floor(x: number, y: number, w: number, h: number): I8Box
  static floor(xy: Readonly<XY<number>>, wh: Readonly<XY<number>>): I8Box
  static floor(box: Readonly<Box<number>>): I8Box
  static floor(
    xXYBox: number | Readonly<XY<number>> | Readonly<Box<number>>,
    yWH?: number | Readonly<XY<number>>,
    w?: number,
    ...
    const box = argsToBox(xXYBox, yWH, w, h)
    return new this(I8XY.floor(box.x, box.y), I8XY.floor(box.w, box.h))
  }

  static round(x: number, y: number, w: number, h: number): I8Box
  static round(xy: Readonly<XY<number>>, wh: Readonly<XY<number>>): I8Box
  static round(box: Readonly<Box<number>>): I8Box
  static round(
    xXYBox: number | Readonly<XY<number>> | Readonly<Box<number>>,
    yWH?: number | Readonly<XY<number>>,
    w?: number,
    ...
    const box = argsToBox(xXYBox, yWH, w, h)
    return new this(I8XY.round(box.x, box.y), I8XY.round(box.w, box.h))
  }

  static fromJSON(json: Readonly<BoxJSON>): I8Box {
    return new this(
      json.xy?.x ?? json.x ?? 0,
      json.xy?.y ?? json.y ?? 0,
      json.wh?.x ?? json.w ?? 0,
  ...
  constructor(
    ...
    const box = argsToBox(xXYBox, yWH, w, h)
    this.#xy = new I8XY(box.x, box.y)
    this.#wh = new I8XY(box.w, box.h)
  }
  ...
  get center(): I8XY {
    return new I8XY(this.centerNum)
  }

  get centerCeil(): I8XY {
    return I8XY.ceil(this.centerNum)
  }

  get centerClamp(): I8XY {
    return I8XY.clamp(this.centerNum)
  }

  get centerFloor(): I8XY {
    return I8XY.floor(this.centerNum)
  }

  get centerRound(): I8XY {
    return I8XY.round(this.centerNum)
  }
  ...
  copy(): this {
    return new I8Box(this.x, this.y, this.w, this.h) as this
  }
  ...
  get end(): I8XY {
    return new I8XY(this.endNum)
  }

  get endClamp(): I8XY {
    return I8XY.clamp(this.endNum)
  }
  ...
  get max(): I8XY {
    return new I8XY(this.maxNum)
  }

  get maxClamp(): I8XY {
    return I8XY.clamp(this.maxNum)
  }
  ...
  get min(): I8XY {
    return new I8XY(this.minNum)
  }

  get minClamp(): I8XY {
    return I8XY.clamp(this.minNum)
  }
