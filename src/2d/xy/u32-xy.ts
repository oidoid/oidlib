...
export class U32XY implements IntegralXY<U32> {
  ...
  static ceil(xy: Readonly<XY<number>>): U32XY
  static ceil(xXY: number | Readonly<XY<number>>, y?: number): U32XY {
    return new this(
      U32.ceil(typeof xXY == 'number' ? xXY : xXY.x),
      U32.ceil(typeof xXY == 'number' ? y! : xXY.y),
    )
  }
  ...
  static floor(xXY: number | Readonly<XY<number>>, y?: number): U32XY {
    return new this(
      U32.floor(typeof xXY == 'number' ? xXY : xXY.x),
      U32.floor(typeof xXY == 'number' ? y! : xXY.y),
    )
  }

  static round(x: number, y: number): U32XY
  static round(xy: Readonly<XY<number>>): U32XY
  static round(xXY: number | Readonly<XY<number>>, y?: number): U32XY {
    return new this(
  ...
  static fromJSON(json: Readonly<XYJSON>): U32XY {
  ...
  constructor(xXY: number | Readonly<XY<number>>, y?: number) {
    this.#x = U32(typeof xXY == 'number' ? xXY : xXY.x)
    this.#y = U32(typeof xXY == 'number' ? y! : xXY.y)
  }

  abs(): this {
    this.#x = U32(Math.abs(this.#x))
    this.#y = U32(Math.abs(this.#y))
    return this
  }
  ...
  add(xXY: number | Readonly<XY<number>>, y?: number): this {
    this.#x = U32(this.#x + (typeof xXY == 'number' ? xXY : xXY.x))
    this.#y = U32(this.#y + (typeof xXY == 'number' ? y! : xXY.y))
    return this
  }
  ...
  addCeil(xXY: number | Readonly<XY<number>>, y?: number): this {
    this.#x = U32.ceil(this.#x + (typeof xXY == 'number' ? xXY : xXY.x))
    this.#y = U32.ceil(this.#y + (typeof xXY == 'number' ? y! : xXY.y))
    return this
  }
  ...
  addFloor(xXY: number | Readonly<XY<number>>, y?: number): this {
    this.#x = U32.floor(this.#x + (typeof xXY == 'number' ? xXY : xXY.x))
    this.#y = U32.floor(this.#y + (typeof xXY == 'number' ? y! : xXY.y))
    return this
  }
  ...
  construct(xXY: number | Readonly<XY<number>>, y?: number): this {
    return new U32XY(xXY as number, y as number) as this
  }
  ...
  constructCeil(xXY: number | Readonly<XY<number>>, y?: number): this {
    return U32XY.ceil(xXY as number, y as number) as this
  }
  ...
  constructClamp(xXY: number | Readonly<XY<number>>, y?: number): this {
    return U32XY.clamp(xXY as number, y as number) as this
  }
  ...
  constructFloor(xXY: number | Readonly<XY<number>>, y?: number): this {
    return U32XY.floor(xXY as number, y as number) as this
  }
  ...
  constructRound(xXY: number | Readonly<XY<number>>, y?: number): this {
    return U32XY.round(xXY as number, y as number) as this
  }

  copy(): this {
    return new U32XY(this.#x, this.#y) as this
  }

  dot(x: number, y: number): U32
  dot(xy: Readonly<XY<number>>): U32
  dot(xXY: number | Readonly<XY<number>>, y?: number): U32 {
    return U32(
  ...
  get len(): U32 {
    return U32(Math.sqrt(this.#x * this.#x + this.#y * this.#y))
  }
  ...
  max(xXY: number | Readonly<XY<number>>, y?: number): this {
    this.#x = U32(Math.max(this.#x, typeof xXY == 'number' ? xXY : xXY.x))
    this.#y = U32(Math.max(this.#y, typeof xXY == 'number' ? y! : xXY.y))
    return this
  }
  ...
  maxCeil(xXY: number | Readonly<XY<number>>, y?: number): this {
    this.#x = U32.ceil(Math.max(this.#x, typeof xXY == 'number' ? xXY : xXY.x))
    this.#y = U32.ceil(Math.max(this.#y, typeof xXY == 'number' ? y! : xXY.y))
    return this
  }
  ...
  maxFloor(xXY: number | Readonly<XY<number>>, y?: number): this {
    this.#x = U32.floor(Math.max(this.#x, typeof xXY == 'number' ? xXY : xXY.x))
    this.#y = U32.floor(Math.max(this.#y, typeof xXY == 'number' ? y! : xXY.y))
    return this
  }
  ...
  min(xXY: number | Readonly<XY<number>>, y?: number): this {
    this.#x = U32(Math.min(this.#x, typeof xXY == 'number' ? xXY : xXY.x))
    this.#y = U32(Math.min(this.#y, typeof xXY == 'number' ? y! : xXY.y))
    return this
  }
  ...
  minCeil(xXY: number | Readonly<XY<number>>, y?: number): this {
    this.#x = U32.ceil(Math.min(this.#x, typeof xXY == 'number' ? xXY : xXY.x))
    this.#y = U32.ceil(Math.min(this.#y, typeof xXY == 'number' ? y! : xXY.y))
    return this
  }
  ...
  minFloor(xXY: number | Readonly<XY<number>>, y?: number): this {
    this.#x = U32.floor(Math.min(this.#x, typeof xXY == 'number' ? xXY : xXY.x))
    this.#y = U32.floor(Math.min(this.#y, typeof xXY == 'number' ? y! : xXY.y))
    return this
  }
  ...
  setCeil(xXY: number | Readonly<XY<number>>, y?: number): this {
    this.#x = U32.ceil(typeof xXY == 'number' ? xXY : xXY.x)
    this.#y = U32.ceil(typeof xXY == 'number' ? y! : xXY.y)
    return this
  }
  ...
  setFloor(xXY: number | Readonly<XY<number>>, y?: number): this {
    this.#x = U32.floor(typeof xXY == 'number' ? xXY : xXY.x)
    this.#y = U32.floor(typeof xXY == 'number' ? y! : xXY.y)
    return this
  }
