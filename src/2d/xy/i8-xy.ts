import { I8, IntegralXY, NumXY, XY, XYJSON } from '@/ooz'

export class I8XY implements IntegralXY<I8> {
  static ceil(x: number, y: number): I8XY
  static ceil(xy: Readonly<XY<number>>): I8XY
  static ceil(xXY: number | Readonly<XY<number>>, y?: number): I8XY {
    return new this(
      I8.ceil(typeof xXY === 'number' ? xXY : xXY.x),
      I8.ceil(typeof xXY === 'number' ? y! : xXY.y),
    )
  }

  static clamp(x: number, y: number): I8XY
  static clamp(xy: Readonly<XY<number>>): I8XY
  static clamp(xXY: number | Readonly<XY<number>>, y?: number): I8XY {
    return new this(
      I8.clamp(typeof xXY === 'number' ? xXY : xXY.x),
      I8.clamp(typeof xXY === 'number' ? y! : xXY.y),
    )
  }

  static floor(x: number, y: number): I8XY
  static floor(xy: Readonly<XY<number>>): I8XY
  static floor(xXY: number | Readonly<XY<number>>, y?: number): I8XY {
    return new this(
      I8.floor(typeof xXY === 'number' ? xXY : xXY.x),
      I8.floor(typeof xXY === 'number' ? y! : xXY.y),
    )
  }

  static round(x: number, y: number): I8XY
  static round(xy: Readonly<XY<number>>): I8XY
  static round(xXY: number | Readonly<XY<number>>, y?: number): I8XY {
    return new this(
      I8.round(typeof xXY === 'number' ? xXY : xXY.x),
      I8.round(typeof xXY === 'number' ? y! : xXY.y),
    )
  }
  ...
  constructor(xXY: number | Readonly<XY<number>>, y?: number) {
    this.#x = I8(typeof xXY === 'number' ? xXY : xXY.x)
    this.#y = I8(typeof xXY === 'number' ? y! : xXY.y)
  }

  abs(): this {
    this.#x = I8(Math.abs(this.#x))
    this.#y = I8(Math.abs(this.#y))
    return this
  }

  absClamp(): this {
    this.#x = I8.clamp(Math.abs(this.#x))
    this.#y = I8.clamp(Math.abs(this.#y))
    return this
  }
  ...
  add(xXY: number | Readonly<XY<number>>, y?: number): this {
    this.#x = I8(this.#x + (typeof xXY === 'number' ? xXY : xXY.x))
    this.#y = I8(this.#y + (typeof xXY === 'number' ? y! : xXY.y))
    return this
  }
  ...
  addCeil(xXY: number | Readonly<XY<number>>, y?: number): this {
    this.#x = I8.ceil(this.#x + (typeof xXY === 'number' ? xXY : xXY.x))
    this.#y = I8.ceil(this.#y + (typeof xXY === 'number' ? y! : xXY.y))
    return this
  }
  ...
  addClamp(xXY: number | Readonly<XY<number>>, y?: number): this {
    this.#x = I8.clamp(this.#x + (typeof xXY === 'number' ? xXY : xXY.x))
    this.#y = I8.clamp(this.#y + (typeof xXY === 'number' ? y! : xXY.y))
    return this
  }
  ...
  addFloor(xXY: number | Readonly<XY<number>>, y?: number): this {
    this.#x = I8.floor(this.#x + (typeof xXY === 'number' ? xXY : xXY.x))
    this.#y = I8.floor(this.#y + (typeof xXY === 'number' ? y! : xXY.y))
    return this
  }
  ...
  addRound(xXY: number | Readonly<XY<number>>, y?: number): this {
    this.#x = I8.round(this.#x + (typeof xXY === 'number' ? xXY : xXY.x))
    this.#y = I8.round(this.#y + (typeof xXY === 'number' ? y! : xXY.y))
    return this
  }
  ...
  get area(): I8 {
    return I8(this.#x * this.#y)
  }

  get areaClamp(): I8 {
    return I8.clamp(this.#x * this.#y)
  }
  ...
  construct(xXY: number | Readonly<XY<number>>, y?: number): this {
    return new I8XY(xXY as number, y as number) as this
  }
  ...
  constructCeil(xXY: number | Readonly<XY<number>>, y?: number): this {
    return I8XY.ceil(xXY as number, y as number) as this
  }
  ...
  constructClamp(xXY: number | Readonly<XY<number>>, y?: number): this {
    return I8XY.clamp(xXY as number, y as number) as this
  }
  ...
  constructFloor(xXY: number | Readonly<XY<number>>, y?: number): this {
    return I8XY.floor(xXY as number, y as number) as this
  }
  ...
  constructRound(xXY: number | Readonly<XY<number>>, y?: number): this {
    return I8XY.round(xXY as number, y as number) as this
  }

  copy(): this {
    return new I8XY(this.#x, this.#y) as this
  }

  dot(x: number, y: number): I8
  dot(xy: Readonly<XY<number>>): I8
  dot(xXY: number | Readonly<XY<number>>, y?: number): I8 {
    return I8(
  ...
  dotClamp(x: number, y: number): I8
  dotClamp(xy: Readonly<XY<number>>): I8
  dotClamp(xXY: number | Readonly<XY<number>>, y?: number): I8 {
    return I8.clamp(
      this.#x * (typeof xXY === 'number' ? xXY : xXY.x) +
        this.#y * (typeof xXY === 'number' ? y! : xXY.y),
    )
  ...
  get len(): I8 {
    return I8(Math.sqrt(this.#x * this.#x + this.#y * this.#y))
  }

  get lenCeil(): I8 {
    return I8.ceil(Math.sqrt(this.#x * this.#x + this.#y * this.#y))
  }

  get lenClamp(): I8 {
    return I8.clamp(Math.sqrt(this.#x * this.#x + this.#y * this.#y))
  }

  get lenFloor(): I8 {
    return I8.floor(Math.sqrt(this.#x * this.#x + this.#y * this.#y))
  }

  get lenRound(): I8 {
    return I8.round(Math.sqrt(this.#x * this.#x + this.#y * this.#y))
  }
  ...
  max(xXY: number | Readonly<XY<number>>, y?: number): this {
    this.#x = I8(Math.max(this.#x, typeof xXY === 'number' ? xXY : xXY.x))
    this.#y = I8(Math.max(this.#y, typeof xXY === 'number' ? y! : xXY.y))
    return this
  }
  ...
  maxCeil(xXY: number | Readonly<XY<number>>, y?: number): this {
    this.#x = I8.ceil(Math.max(this.#x, typeof xXY === 'number' ? xXY : xXY.x))
    this.#y = I8.ceil(Math.max(this.#y, typeof xXY === 'number' ? y! : xXY.y))
    return this
  }
  ...
  maxClamp(xXY: number | Readonly<XY<number>>, y?: number): this {
    this.#x = I8.clamp(Math.max(this.#x, typeof xXY === 'number' ? xXY : xXY.x))
    this.#y = I8.clamp(Math.max(this.#y, typeof xXY === 'number' ? y! : xXY.y))
    return this
  }
  ...
  maxFloor(xXY: number | Readonly<XY<number>>, y?: number): this {
    this.#x = I8.floor(Math.max(this.#x, typeof xXY === 'number' ? xXY : xXY.x))
    this.#y = I8.floor(Math.max(this.#y, typeof xXY === 'number' ? y! : xXY.y))
    return this
  }
  ...
  maxRound(xXY: number | Readonly<XY<number>>, y?: number): this {
    this.#x = I8.round(Math.max(this.#x, typeof xXY === 'number' ? xXY : xXY.x))
    this.#y = I8.round(Math.max(this.#y, typeof xXY === 'number' ? y! : xXY.y))
    return this
  }
  ...
  min(xXY: number | Readonly<XY<number>>, y?: number): this {
    this.#x = I8(Math.min(this.#x, typeof xXY === 'number' ? xXY : xXY.x))
    this.#y = I8(Math.min(this.#y, typeof xXY === 'number' ? y! : xXY.y))
    return this
  }
  ...
  minCeil(xXY: number | Readonly<XY<number>>, y?: number): this {
    this.#x = I8.ceil(Math.min(this.#x, typeof xXY === 'number' ? xXY : xXY.x))
    this.#y = I8.ceil(Math.min(this.#y, typeof xXY === 'number' ? y! : xXY.y))
    return this
  }
  ...
  minClamp(xXY: number | Readonly<XY<number>>, y?: number): this {
    this.#x = I8.clamp(Math.min(this.#x, typeof xXY === 'number' ? xXY : xXY.x))
    this.#y = I8.clamp(Math.min(this.#y, typeof xXY === 'number' ? y! : xXY.y))
    return this
  }
  ...
  minFloor(xXY: number | Readonly<XY<number>>, y?: number): this {
    this.#x = I8.floor(Math.min(this.#x, typeof xXY === 'number' ? xXY : xXY.x))
    this.#y = I8.floor(Math.min(this.#y, typeof xXY === 'number' ? y! : xXY.y))
    return this
  }
  ...
  minRound(xXY: number | Readonly<XY<number>>, y?: number): this {
    this.#x = I8.round(Math.min(this.#x, typeof xXY === 'number' ? xXY : xXY.x))
    this.#y = I8.round(Math.min(this.#y, typeof xXY === 'number' ? y! : xXY.y))
    return this
  }
  ...
  setCeil(xXY: number | Readonly<XY<number>>, y?: number): this {
    this.#x = I8.ceil(typeof xXY === 'number' ? xXY : xXY.x)
    this.#y = I8.ceil(typeof xXY === 'number' ? y! : xXY.y)
    return this
  }
  ...
  setClamp(xXY: number | Readonly<XY<number>>, y?: number): this {
    this.#x = I8.clamp(typeof xXY === 'number' ? xXY : xXY.x)
    this.#y = I8.clamp(typeof xXY === 'number' ? y! : xXY.y)
    return this
  }
  ...
  setFloor(xXY: number | Readonly<XY<number>>, y?: number): this {
    this.#x = I8.floor(typeof xXY === 'number' ? xXY : xXY.x)
    this.#y = I8.floor(typeof xXY === 'number' ? y! : xXY.y)
    return this
  }
  ...
  setRound(xXY: number | Readonly<XY<number>>, y?: number): this {
    this.#x = I8.round(typeof xXY === 'number' ? xXY : xXY.x)
    this.#y = I8.round(typeof xXY === 'number' ? y! : xXY.y)
    return this
  }
