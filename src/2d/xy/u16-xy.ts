import { IntegralXY, NumXY, U16, XY, XYJSON } from '@/ooz'
...
export class U16XY implements IntegralXY<U16> {
  ...
  static clamp(x: number, y: number): U16XY
  static clamp(xy: Readonly<XY<number>>): U16XY
  static clamp(xXY: number | Readonly<XY<number>>, y?: number): U16XY {
    return new this(
      U16.clamp(typeof xXY == 'number' ? xXY : xXY.x),
      U16.clamp(typeof xXY == 'number' ? y! : xXY.y),
    )
  }
  ...
  absClamp(): this {
    this.#x = U16.clamp(Math.abs(this.#x))
    this.#y = U16.clamp(Math.abs(this.#y))
    return this
  }
  ...
  addClamp(xXY: number | Readonly<XY<number>>, y?: number): this {
    this.#x = U16.clamp(this.#x + (typeof xXY == 'number' ? xXY : xXY.x))
    this.#y = U16.clamp(this.#y + (typeof xXY == 'number' ? y! : xXY.y))
    return this
  }
  ...
  get areaClamp(): U16 {
    return U16.clamp(this.#x * this.#y)
  }
  ...
  dot(x: number, y: number): U16
  dot(xy: Readonly<XY<number>>): U16
  dot(xXY: number | Readonly<XY<number>>, y?: number): U16 {
    return U16(
  ...
  dotClamp(x: number, y: number): U16
  dotClamp(xy: Readonly<XY<number>>): U16
  dotClamp(xXY: number | Readonly<XY<number>>, y?: number): U16 {
    return U16.clamp(
      this.#x * (typeof xXY == 'number' ? xXY : xXY.x) +
        this.#y * (typeof xXY == 'number' ? y! : xXY.y),
    )
  ...
  get lenClamp(): U16 {
    return U16.clamp(Math.sqrt(this.#x * this.#x + this.#y * this.#y))
  }
  ...
  maxClamp(xXY: number | Readonly<XY<number>>, y?: number): this {
    this.#x = U16.clamp(Math.max(this.#x, typeof xXY == 'number' ? xXY : xXY.x))
    this.#y = U16.clamp(Math.max(this.#y, typeof xXY == 'number' ? y! : xXY.y))
    return this
  }
  ...
  minClamp(xXY: number | Readonly<XY<number>>, y?: number): this {
    this.#x = U16.clamp(Math.min(this.#x, typeof xXY == 'number' ? xXY : xXY.x))
    this.#y = U16.clamp(Math.min(this.#y, typeof xXY == 'number' ? y! : xXY.y))
    return this
  }
  ...
  setClamp(xXY: number | Readonly<XY<number>>, y?: number): this {
    this.#x = U16.clamp(typeof xXY == 'number' ? xXY : xXY.x)
    this.#y = U16.clamp(typeof xXY == 'number' ? y! : xXY.y)
    return this
  }
