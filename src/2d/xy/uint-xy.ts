...
export class UintXY implements IntegralXY<Uint> {
  ...
  construct(xXY: number | Readonly<XY<number>>, y?: number): this {
    return new UintXY(xXY as number, y as number) as this
  }
  ...
  constructCeil(xXY: number | Readonly<XY<number>>, y?: number): this {
    return UintXY.ceil(xXY as number, y as number) as this
  }
  ...
  constructClamp(xXY: number | Readonly<XY<number>>, y?: number): this {
    return UintXY.clamp(xXY as number, y as number) as this
  }
  ...
  constructFloor(xXY: number | Readonly<XY<number>>, y?: number): this {
    return UintXY.floor(xXY as number, y as number) as this
  }
  ...
  constructRound(xXY: number | Readonly<XY<number>>, y?: number): this {
    return UintXY.round(xXY as number, y as number) as this
  }
