import { IntegralXY, NumXY, U8, XY, XYJSON } from '@/oidlib'
...
export class U8XY implements IntegralXY<U8> {
  ...
  static trunc(x: number, y: number): U8XY
  static trunc(xy: Readonly<XY<number>>): U8XY
  static trunc(xXY: number | Readonly<XY<number>>, y?: number): U8XY {
    return new this(
      U8.trunc(typeof xXY == 'number' ? xXY : xXY.x),
      U8.trunc(typeof xXY == 'number' ? y! : xXY.y),
    )
  }
  ...
  absClamp(): this {
    this.#x = U8.trunc(Math.abs(this.#x))
    this.#y = U8.trunc(Math.abs(this.#y))
    return this
  }
  ...
  addTrunc(xXY: number | Readonly<XY<number>>, y?: number): this {
    this.#x = U8.trunc(this.#x + (typeof xXY == 'number' ? xXY : xXY.x))
    this.#y = U8.trunc(this.#y + (typeof xXY == 'number' ? y! : xXY.y))
    return this
  }
  ...
  get magnitudeClamp(): U8 {
    return U8.trunc(Math.sqrt(this.#x * this.#x + this.#y * this.#y))
  }
  ...
  maxTrunc(xXY: number | Readonly<XY<number>>, y?: number): this {
    this.#x = U8.trunc(Math.max(this.#x, typeof xXY == 'number' ? xXY : xXY.x))
    this.#y = U8.trunc(Math.max(this.#y, typeof xXY == 'number' ? y! : xXY.y))
    return this
  }
  ...
  minTrunc(xXY: number | Readonly<XY<number>>, y?: number): this {
    this.#x = U8.trunc(Math.min(this.#x, typeof xXY == 'number' ? xXY : xXY.x))
    this.#y = U8.trunc(Math.min(this.#y, typeof xXY == 'number' ? y! : xXY.y))
    return this
  }
  ...
  setTrunc(xXY: number | Readonly<XY<number>>, y?: number): this {
    this.#x = U8.trunc(typeof xXY == 'number' ? xXY : xXY.x)
    this.#y = U8.trunc(typeof xXY == 'number' ? y! : xXY.y)
    return this
  }
