...
export class I16XY implements IntegralXY<I16> {
  ...
  construct(xXY: number | Readonly<XY<number>>, y?: number): this {
    return new I16XY(xXY as number, y as number) as this
  }
  ...
  constructCeil(xXY: number | Readonly<XY<number>>, y?: number): this {
    return I16XY.ceil(xXY as number, y as number) as this
  }
  ...
  constructClamp(xXY: number | Readonly<XY<number>>, y?: number): this {
    return I16XY.clamp(xXY as number, y as number) as this
  }
  ...
  constructFloor(xXY: number | Readonly<XY<number>>, y?: number): this {
    return I16XY.floor(xXY as number, y as number) as this
  }
  ...
  constructRound(xXY: number | Readonly<XY<number>>, y?: number): this {
    return I16XY.round(xXY as number, y as number) as this
  }
