import { I16, IntegralXY, NumXY, XY, XYJSON } from '@/oidlib'
...
export class I16XY implements IntegralXY<I16> {
  ...
  static trunc(x: number, y: number): I16XY
  static trunc(xy: Readonly<XY<number>>): I16XY
  static trunc(xXY: number | Readonly<XY<number>>, y?: number): I16XY {
    return new this(
      I16.trunc(typeof xXY == 'number' ? xXY : xXY.x),
      I16.trunc(typeof xXY == 'number' ? y! : xXY.y),
    )
  }
