import { I32, IntegralXY, NumXY, XY, XYJSON } from '@/oidlib'
...
export class I32XY implements IntegralXY<I32> {
  ...
  static trunc(x: number, y: number): I32XY
  static trunc(xy: Readonly<XY<number>>): I32XY
  static trunc(xXY: number | Readonly<XY<number>>, y?: number): I32XY {
    return new this(
      I32.trunc(typeof xXY == 'number' ? xXY : xXY.x),
      I32.trunc(typeof xXY == 'number' ? y! : xXY.y),
    )
  }
  ...
  absClamp(): this {
    this.#x = I32.trunc(Math.abs(this.#x))
    this.#y = I32.trunc(Math.abs(this.#y))
    return this
  }
  ...
  addTrunc(xXY: number | Readonly<XY<number>>, y?: number): this {
    this.#x = I32.trunc(this.#x + (typeof xXY == 'number' ? xXY : xXY.x))
    this.#y = I32.trunc(this.#y + (typeof xXY == 'number' ? y! : xXY.y))
    return this
  }
  ...
  get areaClamp(): I32 {
    return I32.trunc(this.#x * this.#y)
  }
  ...
  maxTrunc(xXY: number | Readonly<XY<number>>, y?: number): this {
    this.#x = I32.trunc(Math.max(this.#x, typeof xXY == 'number' ? xXY : xXY.x))
    this.#y = I32.trunc(Math.max(this.#y, typeof xXY == 'number' ? y! : xXY.y))
    return this
  }
  ...
  minTrunc(xXY: number | Readonly<XY<number>>, y?: number): this {
    this.#x = I32.trunc(Math.min(this.#x, typeof xXY == 'number' ? xXY : xXY.x))
    this.#y = I32.trunc(Math.min(this.#y, typeof xXY == 'number' ? y! : xXY.y))
    return this
  }
  ...
  setTrunc(xXY: number | Readonly<XY<number>>, y?: number): this {
    this.#x = I32.trunc(typeof xXY == 'number' ? xXY : xXY.x)
    this.#y = I32.trunc(typeof xXY == 'number' ? y! : xXY.y)
    return this
  }
